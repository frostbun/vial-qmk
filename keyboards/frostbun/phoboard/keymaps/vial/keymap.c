...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_phoboard(
        ...
        EE_CLR,    _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_PSCR, KC_MPRV, KC_MNXT,  KC_MPLY,
        KC_CAPS,       _______, KC_SLEP, _______, KC_BRIU, KC_BRID, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_VOLD, KC_VOLU,        KC_MUTE,
